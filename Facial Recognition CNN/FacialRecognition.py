...
#CNN
model = Sequential()
model.add(Conv2D(5, kernel_size=(5, 5), strides=(1, 1), activation='relu', input_shape=(96, 96, 1)))
...
model.add(Conv2D(12, kernel_size=(3, 3), strides=(1, 1), activation='relu', data_format='channels_last'))
model.add(MaxPooling2D(pool_size=(3, 3), strides=(1, 1)))
...
for i in range(2049):
    for x in range(30):
        ...
        output.append(row)
print("here")
with open('submissionBRUH.csv', 'w', newline='\n') as f:
    writer = csv.writer(f)
